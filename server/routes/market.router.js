...
router.post('/', (req, res) => {
    if (req.isAuthenticated()) {
        ...
        const qryTxt = `
        INSERT INTO "assets" ("name", "symbol", "quantity", "coin_id", "user_id") 
        VALUES ($1, $2, $3, $4, $5)
        ON CONFLICT ("symbol")
        DO UPDATE SET "quantity" = "assets"."quantity" + $6;`

        pool.query(qryTxt, [coinName, symbol, qty, coinId, userId, qty])
            .then(result => {
